...
export const Basic = () => {
    ...
    const data = [
        {
            name: "Web Site",
            description: "Turli xildagi web site online marketlar, crm sistemalar, portfolio va shu kabi dasturlar",
        ...
        },
        {
            ...
            description: "Telefonda dasturlar yaratamiz",
            icon : "fas fa-mobile"
        },
        {
            name: "Web design",
            description: "Kompaniyangiz web dizaynini yaratib beramiz",
            icon : "fab fa-figma"
        }
    ]
    const responsive = {
                                ...
                                <div className="row">
                                    <div className="col-lg-12 ">
                                        ...
                                        >
                                            {data.map((item) => (
                                                <>
                                                    <div className="item bg-violet me-1 h-100">
                                                        <div className="icon">
