package it.team.uteam.Config;

import it.team.uteam.Security.JwtErrors;
import it.team.uteam.Security.JwtTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/auth/**", "/api/attachment/**")
                .permitAll()
                .antMatchers("/api/worker/**", "/api/footer/**", "/api/message/**", "/api/news/**", "/api/projects/**")
                .permitAll()
